        ...
        <>
        {
            reviewList.map((review,i)=>{
                return  <div key={i} className='bg-neutral px-5 py-7 w-[332px] min-w-[332px] md:w-[420px] md:min-w-[420px] lg:w-[460px] lg:min-w-[460px] mx-2 rounded-3xl'>
                            <div>
                                <p className="font-[SatoshiMedium] text-txtLight leading-4 sm:leading-5 text-[9px] sm:text-[11px]">{review.comment}</p>
                            </div>
                            <div className="flex items-center rounded-full pt-3">
                                ...
                                <div className="ml-2 ">
                                    ...
                                    <p className="text-[8px] sm:text-[10px] font-[SatoshiMedium] text-txtLight">{review.author.position}</p>
                                </div>
                            </div>
                        </div>
            })
